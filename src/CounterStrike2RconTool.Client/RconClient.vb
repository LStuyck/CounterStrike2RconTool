...
Public Class RCONClient
    ...
    Public Sub Connect(ByVal server As String, ByVal port As Integer)
        ...
        Catch ex As Exception
            Close()
            Throw New ConnectFailedException("Could not connect to the server. Check ip/host and port.")
    ...
    Public Sub Authorize(ByVal password As String)
        If Connected = True Then
            ...
            ElseIf a = False Then
                Authorized = False
                Close()
                Throw New AutorizeFailedException("Invalid password or rcon_password cvar is not set.")
